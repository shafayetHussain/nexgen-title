      ...
      <div className="grid gap-6 md:grid-cols-2">
        {services.map((service, index) => (
          <motion.article
            ...
            className="group rounded-[24px] border border-white/10 bg-white/5 p-8 transition hover:-translate-y-1 hover:border-[#d4af37]/50 hover:bg-white/[0.07]"
          >
            <div className="mb-6 h-12 w-12 rounded-full bg-[#d4af37]/10 ring-1 ring-[#d4af37]/30" />
