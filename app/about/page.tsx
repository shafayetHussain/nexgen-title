...
export const metadata: Metadata = {
  title: "About | Nationwide Title Company",
  description:
    "Learn about Nexgen Title Inc., a trusted title company providing professional residential, commercial, escrow, and closing services across the USA.",
  alternates: {
    canonical: "/about",
  },
  openGraph: {
    title: "About Nexgen Title Inc. | Nationwide Title Company",
    description:
      "Learn about Nexgen Title Inc., a trusted title company providing professional residential, commercial, escrow, and closing services across the USA.",
    url: "/about",
  ...
  return (
    <main className="min-h-screen bg-[#0b0b0d] px-4 py-20 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <h1 className="mt-4 font-serif text-4xl sm:text-5xl">Trusted Title Service with Nationwide Reach</h1>
        <p className="mt-6 max-w-3xl leading-8 text-white/75">
          Nexgen Title Inc. serves clients across the USA with dependable residential and commercial title services, escrow support, and closing coordination. Our approach combines professionalism, responsive communication, and a polished client experience.
        </p>
